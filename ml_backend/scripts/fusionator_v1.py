...
splog_dr = load(filename="../models/splog_dr.pkl")
spada_hr = load(filename="../models/spada_hr.pkl")
spgrad_ar = load(filename="../models/spgrad_ar.pkl")
sprand_rs = load(filename="../models/sprand_rs.pkl")
spada_rt = load(filename="../models/spada_rt.pkl")
